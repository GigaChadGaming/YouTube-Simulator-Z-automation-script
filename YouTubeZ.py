...
print("You have 5 seconds to switch to the Roblox game window")
time.sleep(1)

print("You have 4 seconds to switch to the Roblox game window")
time.sleep(1)

print("You have 3 seconds to switch to the Roblox game window")
time.sleep(1)

print("You have 2 seconds to switch to the Roblox game window")
time.sleep(1)

print("You have 1 seconds to switch to the Roblox game window")
time.sleep(1)
